...
public interface CompanyApi {
    ...
    @PostMapping
    long save(@RequestBody Company company);
    ...
    @PutMapping("/{id}")
    ResponseEntity<Company> updateById(@PathVariable int id, @RequestBody Company company);

    @ApiOperation(value = "Delete company with given id")
    @DeleteMapping("/{id}")
    ResponseEntity<Company> deleteById(@PathVariable int id);
